	...
	<div class="page order_refund_page">
		...
		<div class="main-form">
			<div class="main-area scroll-y">
				...
				<Divider dashed />
				<Table  border :columns="table.columns" :width="table.width" :data="table.data" :loading="table.loading" v-if="(activeMenu.code=='all')">
...
<style lang="less">
	...
	.order_refund_page .menu ul {
		height: 100%;
	}

	.order_refund_page .main-form {
		padding-left: 240px;
		height: 100%;
		width: 100%;
		overflow: hidden;
